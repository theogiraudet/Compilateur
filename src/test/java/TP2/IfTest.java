...
public class IfTest {
    ...
    public void if6() throws IOException {
        ...
        final String result = "%1.a = alloca i32\n" +
                              ...
                              "If1:\n" +
                              "%tmp3 = load i32, i32* %1.a\n" +
                              "%tmp4 = add i32 %tmp3, 1\n" +
                              "store i32 %tmp4, i32* %1.a\n" +
                              "br label %End1\n" +
                              "Else1:\n" +
                              "%tmp5 = load i32, i32* %1.a\n" +
                              "%tmp6 = sub i32 %tmp5, 1\n" +
                              "store i32 %tmp6, i32* %1.a\n" +
                              "End1:";
        Program p = createParser(vsl);
        assertTrue(p.toIR().toString().contains(result));
    }
    //TODO voir comportement IF { INT a a := 1 } ELSE { INT a a := 1 }
    ...
    public void if11() throws IOException {
        ...
        final String result = "%1.a = alloca i32\n" +
                              ...
                              "If2:\n" +
                              "%tmp8 = load i32, i32* %1.a\n" +
                              "%tmp9 = sub i32 %tmp8, 1\n" +
                              "store i32 %tmp9, i32* %1.a\n" +
                              "End2:\n" +
                              "End1:";
        Program p = createParser(vsl);
        assertTrue(p.toIR().toString().contains(result));
